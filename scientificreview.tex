...
\title{Improvement among sport by dint of biomimicry}               % Title
\author{LEFAY Paul, CESBRON Théo, HERVE Alexis, GELINEAU Emmanuel, GUYON Soren}                                              % Authors

\renewcommand{\maketitlehookd}{%
\begin{abstract}
  \textbf{Introduction}: This article aims to study various applications of biomimicry to improve human lifestyle. We mostly focus here on the sport field. 
